...
const SlideModal: ForwardRefRenderFunction<sliderRef, Props> = (
  {bottom, padding, call, height, fullHeight, children, header, onClose},
  ref,
) => {
          ...
          style={[
            {
              ...
              overflow: 'hidden',
              alignSelf: 'center',
              borderTopLeftRadius: Fonts.w(21),
              borderTopRightRadius: Fonts.w(21),
              bottom: 0,
              flexShrink: 1,
              borderTopEndRadius: Fonts.w(21),
            },
